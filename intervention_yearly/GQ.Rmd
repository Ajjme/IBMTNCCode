...
gq <- read.csv("G_WQ.csv", header=FALSE)
RawData <- gq[2:6]
...
plot(daymean2016$md,daymean2016$Average,ylim=c(10,1800),
        main="Water Turbidity Level change from 2014 to 2019 in Githambara",
        xlab="Month/Date",
        ylab="Turbidity(NTU)")
lines(daymean2016$md,daymean2016$Average,type="p",pch=20,col="red",xlab="Month/Date",ylab="Turbidity(NTU)", main="data",ylim=c(10,1800))
lines(daymean2015$md,daymean2015$Average,type="p",pch=16,col="green",xlab="Month/Date",ylab="Turbidity(NTU)", main="data",ylim=c(10,1800))
...
```{r}
# plot for daily trend from 2014 to 2019 (except for 2017 and 2014)
plot(daymean2016$md,daymean2016$Average,ylim=c(5,1000),
        main="Water Turbidity Level change from 2014 to 2019 in Githambara",
        xlab="Month/Date",
        ylab="TSS(mg)")
lines(daymean2016$md,daymean2016$Average,type="p",pch=20,col="red",xlab="Month/Date",ylab="TSS(mg)", main="data",ylim=c(5,1000))
lines(daymean2015$md,daymean2015$Average,type="p",pch=16,col="green",xlab="Month/Date",ylab="TSS(mg)", main="data",ylim=c(5,1000))
